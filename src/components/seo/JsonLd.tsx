...
export const JsonLd = () => {
	...
	const software: SoftwareApplication = {
		...
		name: 'Cobalt Axis',
		description:
			'A fully modular scheduling and compliance platform, tailored to your business.',
	...
	const webPage: WebPage = {
		...
		name: 'Cobalt Software Solutions',
		description:
			'Home page for Cobalt Software Solutions, showcasing offerings and contact form.',
		inLanguage: 'en-CA',
