			...
			{formSubmitted ? (
				...
				>
					...
					<p className='text-grey mb-6'>
						We’d love to hear about your business and show you what Cobalt can
						do.
					</p>
					<FormToggle
						render={(isRequestDemo) => (
							<>
								<div
									className={
										isRequestDemo ? 'hidden' : 'block max-w-lg mx-auto'
									}
								>
								...
								<div
									className={
										isRequestDemo ? 'block max-w-lg mx-auto' : 'hidden'
									}
								>
