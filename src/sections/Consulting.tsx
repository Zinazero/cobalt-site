        ...
        <div className="flex flex-col 2xl:flex-row-reverse items-center bg-white max-w-120 2xl:max-w-300 shadow-sm hover:shadow-md transition rounded-2xl overflow-hidden">
          ...
          <div className="2xl:w-1/2 flex flex-col space-y-4 p-2 2xl:p-10">
            ...
            <p className="lg:!text-xl">
              In addition to our Axis platform, we offer custom solutions built from the ground up for you and
              your business. From simple static websites to fully-integrated operational platforms—if you need
              it we build it.
            </p>

            <p className="lg:!text-xl">
              Schedule a one-on-one session with me to explore how custom software can optimize your
              workflows, boost productivity and solve your unique business challenges.
            </p>

            <p className="lg:!text-xl">
              This white-glove consultation is <b>free</b> and completely personalized to your business needs.
            </p>
          </div>
        </div>
